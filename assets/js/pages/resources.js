  ...
  var RESOURCES = {
    ...
    "glossary": {
      ...
      html:
        ...
        '<dt>CEL (Civic Evidence Log)</dt><dd>The append-only record where every interaction outcome — routing accuracy, staff corrections, handle time, containment, SLA results, language confidence — is logged as evidence. The CEL is the &ldquo;Measure&rdquo; step of the Continuous Civic Improvement Loop and the source for every dashboard number and council report. Browse it in the <a href="dashboards.html?tab=cel">Learning Ledger</a>.</dd>' +
