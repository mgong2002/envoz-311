  ...
  var SCENARIOS = [
    ...
    (function () {
      ...
      return {
        ...
        events: [
          ...
          { step: { ic: "route", cls: "warn", html: "<strong>Jurisdiction</strong> · routed to Public Works on a 0.64 match, then held by the surge-cluster monitor. 14 similar reports in 48h are likely one event rather than fourteen cases." } },
          { chips: { pct: c.confidence, rat: c.rationale } },
    ...
    /* 9 — Trash day lookup (grounded answer) */
    {
      ...
      events: [
        ...
        { step: { ic: "doc", cls: "ok", html: "<strong>Grounded lookup</strong> · answer drawn from the city trash schedule rather than guesswork. No case needed." } },
    ...
    /* 10 — External ownership referral */
    {
      ...
      events: [
        ...
        { step: { ic: "shield", cls: "ok", html: "<strong>Safety gate cleared</strong> · congestion rather than an immediate hazard." } },
        { pin: true },
        ...
        { step: { ic: "route", cls: "warn", html: "<strong>Jurisdiction</strong> · GIS ownership layer shows the ramp meter is a <strong>Caltrans District 12</strong> asset rather than a city-maintained one." } },
